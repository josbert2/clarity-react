      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>
              This is the sidebar. It contains navigation and other content.
            </SheetDescription>
          </SheetHeader>
          <SheetContent
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-sidebar p-2",
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "flex min-w-0 flex-col gap-[5px] py-1.5",
      "animate-in slide-in-from-left-1 duration-200",
      "[&>li>a]:rounded-md [&>li>button]:rounded-md",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
